...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 9 months, 6 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> **I'm actively seeking challenging SDET roles focusing on test automation, CI/CD, and performance testing to drive innovative software solutions.**
<!-- AI-BANNER:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Jul 31, 2026 |
