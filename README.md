...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 7 months, 22 days<!-- DURATION:END -->)
...
| :--- | :--- | :--- |
| **[NextRound](https://github.com/justaman045/NextRound)** | AI-powered resume builder with ATS scoring, LaTeX compilation pipeline, multiple templates, cover le... | Jun 16, 2026 |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Jun 16, 2026 |
