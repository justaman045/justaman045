...
<!-- AI-SUMMARY:START -->
I'm a results-driven Software Development Engineer in Test (SDET) with 4.5 years of experience, specializing in architecting scalable test automation frameworks across API, mobile, and desktop for enterprise retail and supply chain systems. I've successfully led complex initiatives, like designing a client-recognized unified cross-platform automation framework and restoring full regression coverage for 200+ failing scripts. Beyond robust QA, I'm passionate about full-stack and AI development, actively building innovative solutions such as the AI-powered `NextRound` resume builder and the `PersonalDashboard` productivity SaaS, reflecting a continuous learning and building ethos.
<!-- AI-SUMMARY:END -->
...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 9 months<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> **Actively seeking SDET, QA Automation, and Full Stack Developer roles, open to early release (90 days notice).**
<!-- AI-BANNER:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Jul 25, 2026 |
| **[NextRound](https://github.com/justaman045/NextRound)** | AI-powered resume builder with ATS scoring, LaTeX templates & GitHub integration | Jul 24, 2026 |
