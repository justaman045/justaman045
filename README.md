...
<!-- AI-SUMMARY:START -->
I'm a results-driven Software Development Engineer in Test (SDET) with 4.5 years of experience, specializing in architecting scalable test automation frameworks across API, mobile, and desktop for enterprise retail and supply chain systems. Beyond ensuring high-quality software at Infosys, I'm passionate about full-stack and AI development, actively building innovative solutions like the AI-powered `NextRound` resume builder and `WealthSync` finance app. My continuous learning and building ethos is exemplified by my recent activity, including work on `Digital-Printing`.
<!-- AI-SUMMARY:END -->
...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 8 months, 17 days<!-- DURATION:END -->)
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Jul 12, 2026 |
| **[NextRound](https://github.com/justaman045/NextRound)** | AI-powered resume builder with ATS scoring, LaTeX templates & GitHub integration | Jul 10, 2026 |
| **[WealthSync](https://github.com/justaman045/WealthSync)** | Privacy-first AI finance app with SMS auto-parsing & 24 asset tracking | Jul 8, 2026 |
...
- 🖥️ **GitHub:** [github.com/justaman045](https://github.com/justaman045)
<!-- AI-CONNECT:END -->
