...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 9 months, 12 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> **Actively seeking challenging SDET, QA Automation, or Full-stack Development roles (open to early release from 90-day notice).**
<!-- AI-BANNER:END -->
...
AI-powered resume builder with ATS scoring, LaTeX templates, and seamless integrations for optimal job application success.
<!-- AI-PROJECT:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Aug 6, 2026 |
| **[JobTracker](https://github.com/justaman045/JobTracker)** | Job application tracker with Kanban, offer comparison & PWA support | Aug 5, 2026 |
| **[NextRound](https://github.com/justaman045/NextRound)** | AI-powered resume builder with ATS scoring, LaTeX templates & GitHub integration | Aug 5, 2026 |
