...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 9 months, 19 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> **Actively seeking challenging SDET and Full Stack Developer roles (open to early release in 90 days) with immediate impact.**
<!-- AI-BANNER:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Aug 13, 2026 |
