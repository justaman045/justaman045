...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 10 months, 13 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> **Open to challenging SDET, QA Automation Engineer, Test Automation Specialist, and Full Stack Developer roles. Available for early release (90-day notice).**
<!-- AI-BANNER:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Sep 7, 2026 |
