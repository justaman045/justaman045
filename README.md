...
<!-- AI-SUMMARY:START -->
I'm a results-driven Software Development Engineer in Test (SDET) with 4.5 years of experience, specializing in architecting scalable test automation frameworks across API, mobile, and desktop for enterprise retail and supply chain systems. Beyond ensuring robust QA through tools like Selenium and REST Assured, I'm passionate about full-stack and AI development, actively building innovative solutions such as the AI-powered `NextRound` resume builder and the `PersonalDashboard` productivity SaaS, reflecting my continuous learning and building ethos.
<!-- AI-SUMMARY:END -->
...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 9 months, 9 days<!-- DURATION:END -->)
...
AI-powered resume builder with ATS optimization, professional LaTeX templates, and seamless integrations.
<!-- AI-PROJECT:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Aug 3, 2026 |
| **[SdetTracker](https://github.com/justaman045/SdetTracker)** | React + Vite learning progress tracker with daily logs, interview preparation modules, roadmaps, and... | Aug 2, 2026 |
| **[JobTracker](https://github.com/justaman045/JobTracker)** | Job application tracker with Kanban, offer comparison & PWA support | Aug 2, 2026 |
