...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 10 months, 16 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> **Open to new Software Development Engineer in Test (SDET) opportunities. Available for early release after a 90-day notice period.**
<!-- AI-BANNER:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Sep 10, 2026 |
| **[WealthSync](https://github.com/justaman045/WealthSync)** | Privacy-first AI finance app with SMS auto-parsing & 24 asset tracking | Sep 9, 2026 |
