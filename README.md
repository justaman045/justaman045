...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 9 months, 28 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> **Actively seeking SDET, QA Automation, or Test Automation Specialist roles. Open to early release (90-day notice).**
<!-- AI-BANNER:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Aug 22, 2026 |
