...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 10 months, 23 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> **Open to new Software Development Engineer in Test (SDET) opportunities where I can leverage my expertise in test automation, framework design, and full-stack development. Actively seeking roles that blend robust QA with innovative AI/ML solutions.**
<!-- AI-BANNER:END -->
...
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Sep 17, 2026 |
