...
<!-- AI-SUMMARY:START -->
I'm a results-driven Software Development Engineer in Test (SDET) with 4.5 years of experience, specializing in architecting scalable test automation frameworks across API, mobile, and desktop for enterprise retail and supply chain systems. Beyond ensuring robust QA, I'm passionate about full-stack and AI development, actively building innovative solutions like the AI-powered `NextRound` resume builder, `WealthSync` finance app, and `PersonalDashboard` productivity SaaS, reflecting my continuous learning and building ethos. My recent activity, including new branches in `multi-music-downloader` and `linux-setup-scripts` projects, demonstrates my commitment to continuous building.
<!-- AI-SUMMARY:END -->
...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 9 months, 26 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> **Actively seeking SDET and Automation Engineer roles. Open to early release (90-day notice period).**
<!-- AI-BANNER:END -->
...
<!-- AI-PROJECT:START -->
### 👉 [NextRound — AI-Powered Resume Builder](https://github.com/justaman045/NextRound)
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Aug 20, 2026 |
| **[linux-setup-scripts](https://github.com/justaman045/linux-setup-scripts)** | One-stop collection of standalone bash scripts: Fedora system provisioning, portable Podman managers... | Aug 16, 2026 |
| **[multi-music-downloader](https://github.com/justaman045/multi-music-downloader)** | Self-contained multi-account YouTube Music liked-music downloader with a terminal UI and a local web... | Aug 15, 2026 |
...
- ✍️ **Hashnode:** [https://justaman045.hashnode.dev](https://justaman045.hashnode.dev)
- 📧 **Email:** [mailto:work.amanojha30@gmail.com](mailto:work.amanojha30@gmail.com)
- 📱 **Phone:** [tel:+918586047520](tel:+918586047520)
<!-- AI-CONNECT:END -->
