...
<!-- AI-SUMMARY:START -->
I'm a results-driven Software Development Engineer in Test (SDET) with 4.5 years of experience, specializing in architecting scalable test automation frameworks across API, mobile, and desktop for enterprise retail and supply chain systems. Beyond robust QA, I'm passionate about full-stack and AI development, actively building innovative solutions like the AI-powered `NextRound` resume builder and `WealthSync` finance app. My recent activity in projects like `multi-music-downloader` and `linux-setup-scripts` further showcases my commitment to hands-on development and continuous learning.
<!-- AI-SUMMARY:END -->
...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 10 months, 15 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> **Open to challenging SDET, QA Automation Engineer, or Full Stack Developer roles, with a 90-day notice period (open to early release).**
<!-- AI-BANNER:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Sep 9, 2026 |
| **[NextRound](https://github.com/justaman045/NextRound)** | AI-powered resume builder with ATS scoring, LaTeX templates & GitHub integration | Sep 3, 2026 |
| **[Nexus](https://github.com/justaman045/Nexus)** | Modern software marketplace with Razorpay + Stripe & admin portal | Sep 3, 2026 |
...
- 깃 **GitHub:** [https://github.com/justaman045](https://github.com/justaman045)
