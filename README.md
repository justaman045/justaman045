...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 10 months, 17 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> **Open to new Software Development Engineer in Test (SDET) roles – available for early release.**
<!-- AI-BANNER:END -->
...
A cross-platform desktop app for headless Naukri profile viewing and updating, leveraging reverse-engineered internal services.
<!-- AI-PROJECT:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Sep 11, 2026 |
| **[WealthSync](https://github.com/justaman045/WealthSync)** | Privacy-first AI finance app with SMS auto-parsing & 24 asset tracking | Sep 10, 2026 |
