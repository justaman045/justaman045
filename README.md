...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 10 months, 9 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> **Open to new opportunities for SDET, QA Automation, or Full-Stack Developer roles. Available for an early release from 90-day notice period.**
<!-- AI-BANNER:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Sep 2, 2026 |
| **[Naukri-Profile-Updater](https://github.com/justaman045/Naukri-Profile-Updater)** | Cross-platform desktop app (Windows/macOS/Linux) to view and update your Naukri profile headlessly o... | Sep 2, 2026 |
