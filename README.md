...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 10 months, 25 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> **Open to new Software Development Engineer in Test (SDET) and QA Automation Engineer roles.** Actively seeking opportunities in scalable test automation and full-stack development. Available after a 90-day notice period, open to early release.
<!-- AI-BANNER:END -->
...
A cross-platform desktop app (Windows / macOS / Linux) for viewing and updating your Naukri profile — completely **headless**.
<!-- AI-PROJECT:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Sep 19, 2026 |
