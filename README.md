...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 7 months, 23 days<!-- DURATION:END -->)
...
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Jun 17, 2026 |
| **[JobTracker](https://github.com/justaman045/JobTracker)** | Full-featured job application tracker with Kanban board, offer comparison engine, dark mode, PWA sup... | Jun 16, 2026 |
