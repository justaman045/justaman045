...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 10 months, 24 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> **Open to new Software Development Engineer in Test (SDET) roles where I can leverage my expertise in test automation architecture, API/mobile/desktop testing, and drive quality engineering initiatives. Ready for early release from my current role after 90 days notice.**
<!-- AI-BANNER:END -->
...
<!-- AI-PROJECT:START -->
### 👉 [Naukri Profile Manager](https://github.com/justaman045/Naukri-Profile-Updater)
A cross-platform desktop app (Windows / macOS / Linux) for viewing and updating your Naukri profile — completely headless using reverse-engineered internal services.
<!-- AI-PROJECT:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Sep 18, 2026 |
