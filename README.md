...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 9 months, 7 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> **Open to full-time roles as an SDET, QA Automation Engineer, or Full Stack Developer. Available for early release with a 90-day notice period.**
<!-- AI-BANNER:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Aug 1, 2026 |
