...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 7 months, 30 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> 📢 **Actively looking for new opportunities as a Senior QA Automation Engineer. Open to early release (90-day notice).**
<!-- AI-BANNER:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Jun 24, 2026 |
| **[Nexus](https://github.com/justaman045/Nexus)** | Modern software marketplace with Razorpay + Stripe & admin portal | Jun 22, 2026 |
| **[JobTracker](https://github.com/justaman045/JobTracker)** | Job application tracker with Kanban, offer comparison & PWA support | Jun 21, 2026 |
