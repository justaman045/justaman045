...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 7 months, 19 days<!-- DURATION:END -->)
...
<!-- AI-BANNER:START -->
> 📢 **Actively looking for new opportunities!** Open to **Senior QA Automation Engineer, SDET, and Full Stack Developer** roles, with a 90-day notice period open to early release.
<!-- AI-BANNER:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Jun 13, 2026 |
| **[SdetTracker](https://github.com/justaman045/SdetTracker)** | React + Vite learning progress tracker with daily logs, interview preparation modules, roadmaps, and... | Jun 11, 2026 |
