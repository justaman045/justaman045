...
<!-- AI-BANNER:START -->
> **Open to new Software Development Engineer in Test (SDET) and Full Stack Developer roles, available for early release after 90 days notice.**
<!-- AI-BANNER:END -->
...
A cross-platform desktop app (Windows/macOS/Linux) for viewing and updating your Naukri profile — completely headless via reverse-engineered internal services.
<!-- AI-PROJECT:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Sep 21, 2026 |
