...
<!-- AI-ROLE:END -->
*Oct 2021 - Present* (<!-- DURATION:START -->4 years, 10 months, 30 days<!-- DURATION:END -->)
...
Cross-platform desktop app (Windows/macOS/Linux) to view and update your Naukri profile — completely headless (no browser window, no Selenium, no Playwright).
<!-- AI-PROJECT:END -->
...
| :--- | :--- | :--- |
| **[justaman045](https://github.com/justaman045/justaman045)** | Personal profile README showcasing my work as an SDET (Java), cross-platform Flutter developer, and ... | Sep 24, 2026 |
